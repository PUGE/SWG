...
// 切换页面特效
switchPage(oldUrlParam,newUrlParam);};window.ozzx={script:{"home":{"data":{"mode":"currency","output":"background","outText":false,"compress":true,"adaptation":"real","bgm":false,"musicSrc":"https://puge-10017157.cos.ap-shanghai.myqcloud.com/swg/bgm.mp3"},"created":function created(){var _this=this;$dom('uploadInput').onchange=function(){_this.upload($dom('uploadInput').files[0]);};// 拖拽上传事件
