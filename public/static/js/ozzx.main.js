...
window.ozzx = {
  script: {
    "home": {
      ...
      "changeAdaptation": function changeAdaptation(clear) {
        console.log('更改模式');
      ...
      "hideModleControl": function hideModleControl() {
        var modleControlList = document.getElementsByClassName('modle-control');

        for (var index = 0; index < modleControlList.length; index++) {
          var element = modleControlList[index];
      ...
      "switchShow": function switchShow(name, defaultValue) {
        ...
        document.getElementsByClassName(name + '-box')[0].style.display = 'block';
        this.data.adaptation = defaultValue;
